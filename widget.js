(() => {
  ...
  // Remove sandbox attributes to test if they're causing issues
  // iframe.setAttribute('sandbox', 'allow-same-origin allow-scripts allow-forms allow-popups allow-modals allow-top-navigation');
  
  // Add additional attributes that might help with cross-origin issues
  ...
  function toggleChat() {
    ...
    if (isOpen) {
      // Reload iframe content when opening
